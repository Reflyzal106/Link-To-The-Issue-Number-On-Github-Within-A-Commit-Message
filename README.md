# [SOLVED] Link-To-The-Issue-Number-On-Github-Within-A-Commit-Message
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/link-to-the-issue-number-on-github-within-a-commit-message)
>
...
Use a pre-commit hook or a Git alias to insert the issue number into the commit message.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/link-to-the-issue-number-on-github-within-a-commit-message)**
